                    ...
                    <Table className="min-w-[1600px] table-fixed text-sm">
                        <TableHeader>
                            <TableRow>
                                ...
                                <TableHead className="sticky right-0 bg-white z-10 whitespace-nowrap text-center w-[180px]">操作</TableHead>
                            </TableRow>
                        </TableHeader>
                        <TableBody>
                            {loading ? (
                                ...
                                drafts.map((draft) => (
                                    <TableRow key={draft.id}>
                                        ...
                                        <TableCell className="whitespace-nowrap text-center"><Badge variant={draft.state == 1 ? "default" : "outline"}>{draft.state == 1 ? '已发布' : '未发布'}</Badge></TableCell>
